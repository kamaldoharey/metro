		...
		<form method="post">
			...
			?>
				<tr>
					...
					<td>
						<center><img class="img-thumbnail" src="../images/sub cat/<?php echo $fetch['image']; ?>" width="200" height="200" alt=""></center>
					</td>
					<td>
						<center><?php echo $fetch['status']; ?></center>
					</td>
					<td>
						<center><a class="form-control btn-primary" href="addsub.php?did=<?php echo $fetch['sno']; ?>" ">Edit</a></center> </td>
