...
<div class="view">
	<table class="table jumbotron">
		<form method="post">
			...
			<tr class="bg-dark">
				<td class="text-white "> <center><input class="btn-primary form-control" type="Submit" value="Delete" name="" id=""></center>	 </td>
				<td class="text-white "> <center>Offer ID </center>	 </td>
				<td class="text-white "> <center>Offers Title</center>	 </td>
				<td class="text-white "> <center>Offers Description</center>	 </td>
				<td class="text-white "> <center>Offers Image</center> </td>
				<td class="text-white "> <center>Offers Status</center> </td>
			...
			while($fetch=mysql_fetch_array($q))
			{
				?>
				<tr>
					<td> <center><input type="checkbox" name="a[]" value="<?php echo $fetch['sno']; ?>" ></center> </td>
					<td> <center> <?php echo $fetch['sno']; ?> </center> </td>
					<td> <center> <?php echo $fetch['name']; ?> </center> </td>
					<td> <center> <?php echo $fetch['offerdec']; ?> </center> </td>
					<td> <center> <img class="img-thumbnail" width="100" height="100" src="../images/offer/<?php echo $fetch['image']; ?>" alt="">  </center> </td>
					<td> <center> <?php echo $fetch['status']; ?> </center> </td>
					<td> <center><a class="form-control btn-primary" href="addoffer.php?did=<?php echo $fetch['sno']; ?>">Edit</a></center> </td>
					<td> <center><a class="form-control btn-danger" href="viewoffer.php?did=<?php echo $fetch['sno']; ?>">Delete</a></center> </td>
				</tr>
				<?php
			}
			?>
