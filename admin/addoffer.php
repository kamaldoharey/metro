                ...
                // file upload code end here
                    ...
                    <form method="post" enctype="multipart/form-data">
                        ...
                        <tr>
                            <?php if ($_GET['did']!="") {
                                ?>
                                <img class="img-thumbnail" src="imageupload/<?php echo $fetch['image']; ?>" alt="">
                            <?php }  ?>
                        </tr>
                        <tr>
                            <td>Status</td>
                            <td>
                                Enable <input value="1" type="radio" name="co4" id=""> Disable <input value="0" type="radio" name="co3" id="">
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align: center;" colspan="2">
                                <input class="btn-primary form-control" type="submit" value="Submit" name="submit" id=""></td>
                            </tr>
                        </form>
                    </table>
                </div>
