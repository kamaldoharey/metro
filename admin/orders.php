		...
		<form method="post">
			...
			?>
				<tr>
					...
					<td>
						<center> <?php echo $fetch['uid'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['name'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['price'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['date'] ?> </center>
					</td>
					<td>
						<center> <a class="form-control btn-danger" href="orders.php?did=<?php echo $fetch['sno'] ?>">Delete</a> </center>
					</td>
				</tr>
			<?php } ?>
		</form>
