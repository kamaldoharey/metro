		...
		<form method="post">
			...
			?>
				<tr>
					...
					<td>
						<center><a class="form-control btn-primary" href="addcatagory.php?did=<?php echo $fetch['sno'] ?>">Edit</a></center>
					</td>
					<td>
						<center><a class="form-control btn-danger" href="viewcatagory.php?did=<?php echo $fetch['sno'] ?>">Delete</a></center>
					</td>
				<?php } ?>
				</tr>
		</form>
