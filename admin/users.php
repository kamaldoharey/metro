...
<div class="view">
	<table class="table jumbotron">
		<form method="post">
			...
			<tr class="bg-dark">
				<td class="text-white">
					<center> <input class="form-control btn-primary" type="submit" name="" id=""> </center>
				</td>
				<td class="text-white">
					<center> Name </center>
				</td>
			...
			?>
				<tr>
					...
					<td>
						<center> <?php echo $fetch['dob'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['address'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['state'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['check1'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['phone'] ?> </center>
					</td>
					<td>
						<center> <?php echo $fetch['email'] ?> </center>
					</td>
					<td>
						<center> <img class="img-thumbnail" src="../images/user/<?php echo $fetch['photo'] ?>" width="200" alt="Error"> </center>
					</td>
					<td>
						<center> <?php echo $fetch['password'] ?> </center>
					</td>
					<td>
						<center> <a class="form-control btn-primary" href="">Delete</a>
					</td>
				<?php } ?>
				</tr>
		</form>
