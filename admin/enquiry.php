	...
	<table class="table jumbotron">
		<form method="post" >
			...
			<tr class="bg-dark">
				...
				<td class="text-white"> <center>ID</center> </td>
				<td class="text-white"> <center>User Name</center> </td>
				<td class="text-white"> <center>Enquiry</center> </td>
				<td class="text-white"> <center>Phone</center> </td>
			...
			while ($fetch = mysql_fetch_array($exe) ) 
			{
				...
				<tr>
					...
					<td> <center> <?php echo $fetch['enquiry']; ?> </center> </td>
					<td> <center> <?php echo $fetch['phone']; ?> </center> </td>
					<td> <center> <a class="form-control btn-danger" href="enquiry.php?did=<?php echo $fetch['sno']; ?>">Delete</a> </center> </td>
				</tr>
			<?php } ?>
		</form>
	</table>
