...
<div class="about-us-div">
	<h2 class="bg-success text-white"> <b> &nbsp About Us</b> </h2>
	<div class="about-us-page-content">
		...
		<h4 class="text-success">Statistics</h4>
		...
		<p>Over 3 million square foot (equivalent in size to more than 10 football fields), the Metro Mall has a total internal floor area of 1.9 million square feet (55 ha) and leasable space of 0.77 million square feet (35 ha), about the same as the West Edmonton Mall. It also has a 25-room luxury hotel, 10 cinema screens plus 50 restaurants and cafes. The Mall has over 7,000 parking spaces across 3 car parks, with valet services and a car locator ticketing system.
		<h4 class="text-success">Location</h4>
		</p>Metro Mall is located at 1 km distance from Metro station, 1.5 km distance from Railway station and On the main road of Jaipur i.e; M.I. Road.</p>
	</div>
</div>
